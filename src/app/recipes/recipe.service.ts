...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    new Recipe('Creamy Doughnut',
      'A sweet doughnut just for sweet you!',
      'http://www.aimadeitforyou.com/wp-content/uploads/2016/04/IMG_9564-1024x683.jpg',
      [new Ingredient('Whole Milk', 1), new Ingredient('Bread Flour cups', 2)]),
    new Recipe('Bad-ass Burger',
      ...
      [new Ingredient('Buns', 2), new Ingredient('Patty', 1), new Ingredient('Cheese Slices', 2)]),
  ];
